...
import os
import algonauts.src.lib.utils.networks_factory as networks_factory
import algonauts.src.lib.utils.constants as constants
import torch
...
class Config(object):
    def __init__(self):
        ...
        self.parser.add_argument('--test_set', help='perform the operations only on the test data',
                                 action="store_true")
        self.parser.add_argument('--pretrained', help='Use Alexnet, VGG 16, VGG 19, Inception pretrained models',
                                 action="store_true")
